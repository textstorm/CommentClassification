...
def get_args():
  ...
  parser.add_argument('--sentence_length', type=int, default=1000, help='The length of input x')
  ...
  parser.add_argument('--max_step_cnn', type=int, default=48000, help='max cnn train step')

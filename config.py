...
def get_args():
  ...
  parser.add_argument('--rnn_type', type=str, default="rnn", help='rnn or bi-rnn')

  parser.add_argument('--sentence_length', type=int, default=50, help='The length of input x')
  parser.add_argument('--vocab_size', type=int, default=10000, help='data vocab size')
  parser.add_argument('--embed_size', type=int, default=64, help='dims of word embedding')
  parser.add_argument('--filter_sizes', type=list, default=[3, 4, 5], help='')
  parser.add_argument('--num_filters', type=int, default=50, help='num of filters')
  ...
  parser.add_argument('--max_step', type=int, default=20000, help='max train step')

...
def get_args():
  ...
  parser.add_argument('--train_dir', type=str, default='data/pre/train_aug_50000.csv')
  parser.add_argument('--valid_dir', type=str, default='data/pre/dev_new.csv')
  ...
  parser.add_argument('--max_step_rnn', type=int, default=7000, help='max rnn train step')

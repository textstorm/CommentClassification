...
def get_args():
  ...
  parser.add_argument('--glove_dir1', type=str, default='../data/glove/glove.twitter.27B.200d.txt')
  parser.add_argument('--glove_dir2', type=str, default='../data/glove/glove.twitter.27B.100d.txt')
  parser.add_argument('--glove_dir3', type=str, default='../data/glove/glove.twitter.27B.50d.txt')
  parser.add_argument('--use_wv', type=str, default="glove1", help='which word vector to use')
  parser.add_argument('--save_dir', type=str, default='save/saves')

  # model
  parser.add_argument('--model_type', type=str, default="cnn", help='cnn,rnn,attention,chrnn')
  ...
  parser.add_argument('--vocab_size', type=int, default=20002, help='data vocab size')

...
def get_args():
  ...
  parser.add_argument('--glove_dir2', type=str, default='../data/glove/glove.twitter.27B.200d.txt', help='glove dir')
  ...
  # model
  parser.add_argument('--model_type', type=str, default="rnn", help='cnn,rnn,attention,chrnn')

...
def get_args():
  ...
  parser.add_argument('--test_dir', type=str, default='data/pre/test_trans.csv', help="test data")
  ...
  parser.add_argument('--max_step_cnn', type=int, default=30100, help='max cnn train step')  
  #rnn
